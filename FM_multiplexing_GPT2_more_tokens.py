...
def demonstrate_fm_gpt2_steganography():
    ...
    # Configure agents with HIGHER frequencies for shorter sequences
    agents_config = {
        'ALICE': {'freq': 0.05, 'color': 'blue'},    # Increased from 0.15
        'BOB': {'freq': 0.10, 'color': 'green'},     # Increased from 0.30
        'CHARLIE': {'freq': 0.15, 'color': 'red'}    # Increased from 0.45
    }
    ...
    print(f"\nGenerating {200} tokens with embedded messages...\n")
